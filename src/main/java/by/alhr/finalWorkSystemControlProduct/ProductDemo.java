...
public class ProductDemo {
    public static void main(String[] args) throws ProductValidationException {
        Product product1 = new Product("Milk", BigDecimal.valueOf(2.12),"Milk from Minsk", Category.MILK_PRODUCTS);
        Product product2 = new Product("Cake", BigDecimal.valueOf(9.50),"Cake from Grodno", Category.CONFECTIONERY);
        Product product3 = new Product("Apple", BigDecimal.valueOf(3.24),"Apple from Parychi", Category.FRUIT);
        ...
        Product product9 = new Product("Banana", BigDecimal.valueOf(3.33),"Banana from Nigeria", Category.FRUIT);
